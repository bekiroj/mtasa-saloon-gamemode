...
Roboto = exports.vn_fonts:getFont('Roboto', 11)
...
addCommandHandler("debugon",
	function ()
		if not debugscriptActive then
			...
			outputChatBox("Debugscript active.")
			setElementData(localPlayer, 'debug.on', true)
		end
	end
)
...
addCommandHandler("debugoff",
	function ()
		if debugscriptActive then
			...
			outputChatBox("Debugscript de-active.")
			setElementData(localPlayer, 'debug.on', false)
		end
	end
)
